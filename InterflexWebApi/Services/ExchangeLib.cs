...
{
    public class ExchangeLib : IExchangeLib
    {
        private static ExchangeService InitializeExchangeService(string userName, string password)
        {
            ...
            service.Credentials = new NetworkCredential(userName, password, "INT\\");
        ...
        public async Task<(List<Exchange>, bool)> GetExchangeData(string userName, string password)
        {
